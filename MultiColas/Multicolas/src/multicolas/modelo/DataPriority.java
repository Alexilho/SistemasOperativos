...
public class DataPriority implements IDataBuild{
   ...
   public void agregarPrioridad(int tActual){
          getCola().ordenarLLegadaMinToMAX();
        if(actual!=null){
            //System.out.println("prioridad"+data.getCola().getPrimero().getSig().getPrioridad());
            if(getCola().getPrimero().getSig().getPrioridad()>actual.getPrioridad()){
